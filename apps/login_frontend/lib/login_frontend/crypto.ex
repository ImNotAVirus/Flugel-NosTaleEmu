defmodule LoginFrontend.Crypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> LoginFrontend.Crypto.encrypt("fail Hello. This is a basic test")
  ...
  ## Examples
    ...
    iex> LoginFrontend.Crypto.decrypt_pass("2EB6A196E4B60D96A9267E")
    "admin"
    iex> LoginFrontend.Crypto.decrypt_pass("1BE97B527A306B597A2")
    "user"
