defmodule ChannelFrontend.Packets.Player.Views do
  @moduledoc """
  TODO: Documentation for ChannelFrontend.Packets.Player.Views
  """

  use ElvenGard.View

  alias ChannelFrontend.Enums.Character, as: EnumsChar
